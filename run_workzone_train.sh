...
#
# Usage:
#   bash run_workzone_train.sh                     # headless, from scratch
#   bash run_workzone_train.sh --no-headless       # with GUI
#   CHECKPOINT=checkpoints/my_policy.pt bash run_workzone_train.sh  # from checkpoint
