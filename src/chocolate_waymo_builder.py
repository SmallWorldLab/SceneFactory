...
class WaymoJsonMiniWorldBuilder:
    ...
    def _spawn_traffic_cone(
        ...
        *,
        ...
        vis_h = cone_height_m * 6.0 if video_beacon else cone_height_m
    ...
    def build_workzone_cones(self, cfg: Dict[str, Any], *, video_cone_markers: bool = False) -> None:
        ...
        Reads ``cfg["workzone"]["cones"]`` (list of {x, y, z} world-space dicts) and:
          ...
          4. Reads ``cfg["workzone"]["forbidden_boxes"]`` (list of box dicts) and writes
        ...
        if cones_raw:
            ...
            for i, c in enumerate(cones_raw):
                ...
                self._spawn_traffic_cone(
                    ...
                    y=float(ly),
                    z=float(lz),
                    video_beacon=video_cone_markers,
                )
        ...
        boxes_raw = wz.get("forbidden_boxes", []) or []
        if boxes_raw:
            ...
            for b in boxes_raw:
                try:
                    ...
                    continue
            if flat_boxes:
                root_prim.SetCustomDataByKey("workzone_forbidden_boxes", Vt.FloatArray(flat_boxes))
    ...
    def build_from_json(
        ...
        *,
        ...
        # video visibility
        video_cone_markers: bool = False,  # add tall glowing beacon poles above cones
    ) -> None:
        ...
        self.build_workzone_cones(cfg, video_cone_markers=video_cone_markers)
